...
app.get('/team_stats', function(req, res){
	...
	.then( data => {       /*making an array that stores your results from your queries*/
...
app.get('/player_info/post', function(req, res){
	...
	var playerNameAndId = 'SELECT name, id FROM football_players;';
	var playerInfo = 'SELECT * FROM football_players WHERE id =';
	playerInfo += playerID; 
	playerInfo  += ';';
	var playerGame = 'SELECT COUNT (*) FROM football_players INNER JOIN football_games ON football_players.id = ANY(football_games.players) WHERE football_players.id =';
	playerGame += playerID;
	playerGame +=';';

	db.task('get-everything', task => {
		return task.batch([
			task.any(playerNameAndId),
			task.any(playerInfo), 
			task.any(playerGame)
		]);
	})
